...
public class Day14_BTVN_ALADA_Page {
	...
	{
		textEmail_login.clear();
		textEmail_login.sendKeys(email);
		textPassword_login.clear();
		textPassword_login.sendKeys(password);
		buttonLogin.click();
	}
	public void EditPasswordFunction(WebDriver driver, String currentPassword, String newPassword, String reenterPassword)
	{
		avatar.click();
